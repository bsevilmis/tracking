...
%EMD setup
addpath(genpath('/home/berksevilmis/Desktop/Research/FastEMD'));
...
% extract features
load('./Results/SegTrackv2/HoiemResults/girlv3/currentWorkspacev2.mat')
nbOfSuperPixels = 750;
spFeatures = [];
...
for frameNumber = 2:numberOfFrames
    % obtain observation
    observedImage = imread([framesPath '/' framesFolder(2+frameNumber).name]);
    % obtain location prior and foreground probability
